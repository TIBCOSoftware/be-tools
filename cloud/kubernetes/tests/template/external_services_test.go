...
func TestExternalServices(t *testing.T) {
	...
	values := map[string]string{
		...
		"agents[2].expose[0].name":                                "jmx",
		"agents[2].expose[0].port":                                "5555",
		"agents[2].expose[0].type":                                "ClusterIP",
		"agents[2].expose[1].name":                                "one",
		"agents[2].expose[1].port":                                "1111",
		"agents[2].expose[1].type":                                "NodePort",
		"agents[2].expose[2].name":                                "two",
		"agents[2].expose[2].port":                                "2222",
		"agents[2].expose[2].type":                                "LoadBalancer",
