...
prop_keys="$(/home/tibco/be/configproviders/gvconsul/consul kv export -http-addr=$CONSUL_SERVER_URL $BE_APP_NAME/$APP_CONFIG_PROFILE | /home/tibco/be/configproviders/jq -r '.[] | .key')";

echo {  > temp.json
for prop in $prop_keys
do
echo \"${prop:prefix_len}\":\"$(/home/tibco/be/configproviders/gvconsul/consul kv get -http-addr=$CONSUL_SERVER_URL $prop)\", >> temp.json
