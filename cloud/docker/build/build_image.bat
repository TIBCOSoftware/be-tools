...
set "S2I_DOCKER_FILE_APP=Dockerfiles2i"
...
if !ARG_TYPE! EQU !APP_IMAGE! (
    ...
    set "DOCKER_FILE=Dockerfile-rms"
) else if !ARG_TYPE! EQU !TEA_IMAGE! (
    set "DOCKER_FILE=Dockerfile-teagent"
...
:printUsage
    ...
    echo                            Note: No need to specify be-home if script is executed from BE_HOME/cloud/docker/build folder.
    echo.
