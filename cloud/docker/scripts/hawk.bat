...
set VALID_HAWK_MAP_MAX[6.3.1]=7.2.2
set VALID_HAWK_MAP_MIN[6.3.2]=7.1.0
set VALID_HAWK_MAP_MAX[6.3.2]=7.3.0
set VALID_HAWK_MAP_MIN[6.4.0]=7.1.0
set VALID_HAWK_MAP_MAX[6.4.0]=7.3.0
