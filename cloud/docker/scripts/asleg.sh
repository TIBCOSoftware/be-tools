...
asLegPckgs=$(find $ARG_INSTALLER_LOCATION -name "TIB_activespaces_[0-9]\.[0-9]\.[0-9]_linux_x86_64.zip" -maxdepth 1 )
asLegPckgsCnt=$(find $ARG_INSTALLER_LOCATION -name "TIB_activespaces_[0-9]\.[0-9]\.[0-9]_linux_x86_64.zip" -maxdepth 1 |  wc -l)
asLegHfPckgs=$(find $ARG_INSTALLER_LOCATION -name "TIB_activespaces_[0-9]\.[0-9]\.[0-9]_HF-[0-9][0-9][0-9]_linux_x86_64.zip" -maxdepth 1 )
asLegHfPckgsCnt=$(find $ARG_INSTALLER_LOCATION -name "TIB_activespaces_[0-9]\.[0-9]\.[0-9]_HF-[0-9][0-9][0-9]_linux_x86_64.zip" -maxdepth 1 |  wc -l)
