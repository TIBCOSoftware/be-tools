...
if !INSTALLATION_TYPE! EQU fromlocal (
    ...
    if !BE6VAL! GEQ 630 if "!IMAGE_NAME!" EQU "!TEA_IMAGE!" (
        ...
        if !ARG_TEA_VERSION! NEQ na set ARG_TEA_SHORT_VERSION=!ARG_TEA_VERSION:~0,3!
    )
